...
<div class="about-link">
    <p class="wiki-link">
        <a href="staff-members.php" id="wiki-1">OUR&nbsp;MEMBERS</a>
    </p>
</div>
<div class="staff-list">
    <div class="member-box-1"><span><img class="d-block w-100" src="CSS/principal-image.jpg"></span>
   <p class="qualification"> <b>PROF.(DR.) DULU PATNAIK</b> <br><br> POST<b>:</b>  PRINCIPAL (GCEK)<br><br>QUALIFICATION<b>:</b>  Ph.D. (Engineering), Ph.D. (Management), D.Litt (Hons)<br><br>EMAIL-ID <b>:</b><a class="staff-mail" href="mailto:librarian@gcekbpatna.ac.in">  principalgcek@gmail.com</a></p> 
</div>
</div>
